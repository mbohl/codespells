...
World.prototype.settle = function(iterations) {
	...
	z = this.z;
        ...
        var prev_iteration_count = 0;

        console.log("Settling world ", iterations, " times.");
		...
		*/
		...
		for (i = 0; i < this.x; i++) {
			...
			for (j = 0; j < this.y; j++) {
                ...
                console.log("Made ", iteration_count, " moves for iteration ", q, ".");

                if (prev_iteration_count == iteration_count) {
                    console.log('Dropping out early at iteration, ', q, ', steady state reached');
                    q = iterations;
                }
        ...
        console.log("Made ", run_count, " total moves across ", iterations, " iterations.");
